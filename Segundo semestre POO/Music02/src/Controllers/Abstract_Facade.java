...
public abstract class Abstract_Facade<T> {
    ...
    public boolean delete(int id){
        try {
            ...
            e.printStackTrace();
            System.err.println("Lo sentimos, no se pudo eliminar el estudiante, porque la estructura es nula");
            return false;

        }catch(ArrayIndexOutOfBoundsException e){
            System.err.println("Lo sentimos, no se pudo eliminar el estudiante, porque se permiten máximo " + data.length + " caracteres");
            return false;
